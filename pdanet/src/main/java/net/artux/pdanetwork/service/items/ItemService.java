...
public class ItemService {
    ...
    public <T extends ItemEntity> ItemService(Logger logger, ObjectMapper objectMapper, ItemMapper itemMapper,
        ...
        try {
            for (net.artux.pdanetwork.service.items.ItemType type : net.artux.pdanetwork.service.items.ItemType.values()) {
    ...
    private <T extends ItemEntity> List<T> readType(net.artux.pdanetwork.service.items.ItemType type) throws IOException {
    ...
    private <T extends ItemEntity> void addAsNotCountable(UserEntity user, T item) {
        ...
        if (type.isWearable()) {
            if (type.getTypeClass() != ArtifactDto.class) {
