...
public class ConversationServiceImpl implements ConversationService {
    ...
    private void validateConversation(ConversationCreateDTO createDTO, ConversationEntity conversationEntity) {
        if(createDTO.getType() == ConversationType.PRIVATE && createDTO.getUsers().size() != 1) {
        ...
        conversationEntity.setType(ConversationEntity.Type.valueOf(createDTO.getType().name()));
