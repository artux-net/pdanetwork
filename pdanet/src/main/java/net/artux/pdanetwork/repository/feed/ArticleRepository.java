...
public interface ArticleRepository extends JpaRepository<ArticleEntity, UUID> {
    ...
    @Query("select new net.artux.pdanetwork.dto.ArticleSimpleDto(a, count(distinct al.id), count(distinct c.id)) from ArticleEntity a " +
    ...
    @Query("select new net.artux.pdanetwork.dto.ArticleDto(a, count(distinct al.id), count(distinct c.id)) from ArticleEntity a " +
            "left join a.likes al " +
            "left join a.comments c " +
