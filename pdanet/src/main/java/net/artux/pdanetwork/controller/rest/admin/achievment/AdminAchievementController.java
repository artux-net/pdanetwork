...
public class AdminAchievementController {
    ...
    public AchDto createAchievement(@Valid @RequestBody AchievementCreateDto createDto, @PathVariable UUID id) {
        return achievementService.createAchievement(id, createDto);
    }
